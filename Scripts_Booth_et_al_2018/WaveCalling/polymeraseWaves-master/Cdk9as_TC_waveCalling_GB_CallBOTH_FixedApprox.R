...
fig_dir = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/figures/cdk9asTC_waves/10-03-17/BothWaves/TryTSmooth_6Kbgenes/fixedApprox_3kb/"#
dir.create(fig_dir)
...
approxClearStart_30sec = 3000 # note:  relative to the shifted TSS (actually 3 kb from TSS)
approxClearStart_1min = 3000 # note:  relative to the shifted TSS (actually 3 kb from TSS)
approxClearStart2.5min = 3000 # note:  relative to the shifted TSS (actually 3 kb from TSS).  Actually farther, but some genes are only 4kb long (i.e. max).
