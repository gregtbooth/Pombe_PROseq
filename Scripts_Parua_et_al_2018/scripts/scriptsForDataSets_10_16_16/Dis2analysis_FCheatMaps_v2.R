...
fig_dir = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/figures/FC_heatMaps/06-22-17/"
dir.create(fig_dir)
...
UntreatedCountDat = read.table(file = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/countData/AllGenesObsTSS/ePRO_Cdk9as_0min_combinedPIcountData.txt")
Min20CountDat = read.table(file = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/countData/AllGenesObsTSS/ePRO_Cdk9as_20min_combinedPIcountData.txt")
###################################################################################################################
NFs = read.table(file = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/countData/combined_spikeNormFactors.txt", head = T)
repNFs = read.table(file = "/Volumes/SEAGATE_EXP/Fisher_collaboration/analysis/countData/replicate_spikeNormFactors.txt", head = T)
